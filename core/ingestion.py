...
def seed_database_single_file(file_path: str) -> None:
    """
    Ingests a single file, cuts it into fragments and inserts them into the vector database with their metadata.
    """
