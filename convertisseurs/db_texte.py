...
vectorstore = Chroma.from_documents(
    ...
    persist_directory="./chroma_db" # Dossier où la base sera sauvée
)
...
qa_chain = RetrievalQA.from_chain_type(
    llm=llm,
    chain_type="stuff",
    retriever=vectorstore.as_retriever(search_kwargs={"k": 2}) # k=2 signifie "trouve les 2 morceaux les plus pertinents"
)
