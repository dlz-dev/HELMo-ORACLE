      ...
      <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
        <Card className="w-full max-w-sm border-[var(--border)] bg-[var(--surface)] shadow-lg text-center">
          <CardContent className="pt-10 pb-8 space-y-4">
            ...
            <h1 className="font-cinzel text-xl font-semibold text-[var(--text)] tracking-widest uppercase">Oracle</h1>
            <p className="text-[var(--text-muted)] text-sm">Mode local activé</p>
      ...
      <div className="w-full max-w-sm space-y-4 animate-fade-up">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[var(--text-muted)] text-sm">
            {mode === "login" ? "Connecte-toi pour accéder aux archives" : "Crée ton compte"}
          </p>
        </div>
        ...
        <Card className="border-[var(--border)] bg-[var(--surface)] shadow-md">
          <CardContent className="pt-6 pb-6 px-6 space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full border-[var(--border)] bg-[var(--bg-subtle)] text-[var(--text)] hover:bg-[var(--bg-muted)] hover:border-[var(--gold)]/30 gap-2"
            >
            ...
            <div className="relative">
              ...
              <span className="absolute left-1/2 -translate-x-1/2 -top-2.5 bg-[var(--surface)] px-2 text-[10px] text-[var(--text-subtle)]">
                ou par email
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              {mode === "signup" && (
                <div className="flex gap-2">
                  <div className="flex-1 space-y-1">
                    <label className="text-[10px] text-[var(--text-subtle)] uppercase tracking-wide">Prénom</label>
                    <Input
                      type="text"
                      value={firstName}
                  ...
                  <div className="flex-1 space-y-1">
                    <label className="text-[10px] text-[var(--text-subtle)] uppercase tracking-wide">Nom</label>
                    <Input
                      type="text"
                      value={lastName}
              ...
              <div className="space-y-1">
                <label className="text-[10px] text-[var(--text-subtle)] uppercase tracking-wide">Email</label>
                <Input
                  type="email"
                  value={email}
              ...
              <div className="space-y-1">
                <label className="text-[10px] text-[var(--text-subtle)] uppercase tracking-wide">Mot de passe</label>
                <div className="relative">
                  <Input
              ...
              {mode === "signup" && (
                <div className="space-y-1">
                  <label className="text-[10px] text-[var(--text-subtle)] uppercase tracking-wide">Profil</label>
                  <select
                    value={role}
              ...
              {error   && <p className="text-xs text-red-400 bg-red-400/8 border border-red-400/20 px-3 py-2 rounded-md">{error}</p>}
              {success && <p className="text-xs text-emerald-400 bg-emerald-400/8 border border-emerald-400/20 px-3 py-2 rounded-md">{success}</p>}
